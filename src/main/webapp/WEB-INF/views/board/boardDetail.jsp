            ...
            <div class="row">
                <div class="col-xs-12 col-md-9 write-wrap">
                        ...
                        <form>
                            ...
                            <button type="button" id="modBtn" class="btn btn-primary" onclick="location.href='${pageContext.request.contextPath}/board/modContent?bno=${bno}'">변경</button>
                            <button type="button" id="listBtn" class="btn btn-dark" onclick="location.href='<c:url value="/board/list"/>'">목록</button>
                    </form>
                </div>
            </div>
        </div>
